...
import AIGroceryGenerator from '../grocery/AIGroceryGenerator'
  ...
  // Add these imports at the top
   ...
   import { User, ShoppingBag, ClipboardList, History, Users, List, Zap } from "lucide-react"
              ...
              <div className="flex items-center space-x-4">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-56 bg-gray-900 border-gray-800">
                    ...
                    <DropdownMenuItem onClick={() => router.push('/user/dashboard')} className="text-gray-300 focus:text-white focus:bg-gray-800">
                      <User className="mr-2 h-4 w-4" />
                      Dashboard
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => router.push('/products')} className="text-gray-300 focus:text-white focus:bg-gray-800">
                      <ShoppingBag className="mr-2 h-4 w-4" />
                      Products
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => router.push('/shopping-list')} className="text-gray-300 focus:text-white focus:bg-gray-800">
                      <List className="mr-2 h-4 w-4" />
                      Shopping Lists
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => router.push('/inventory')} className="text-gray-300 focus:text-white focus:bg-gray-800">
                      <ClipboardList className="mr-2 h-4 w-4" />
                      Inventory
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => router.push('/order-history')} className="text-gray-300 focus:text-white focus:bg-gray-800">
                      <History className="mr-2 h-4 w-4" />
                      Order History
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => router.push('/family')} className="text-gray-300 focus:text-white focus:bg-gray-800">
                      <Users className="mr-2 h-4 w-4" />
                      Family
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => setShowSettings(true)} className="text-gray-300 focus:text-white focus:bg-gray-800">
                      <Settings className="mr-2 h-4 w-4" />
                      Preferences
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => router.push('/quick-actions')} className="text-gray-300 focus:text-white focus:bg-gray-800">
